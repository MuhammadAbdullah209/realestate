...
const Lisitng_edit = () => {
  ...
  useEffect(() => {
    const fetchListing = async () => {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/Api/Listings/getListing/${id}`
      );
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/Api/Listings/Update/${params.id}`,
        {
          method: "POST",
      ...
      if (files.length > 0) {
        ...
        await fetch(
          `${import.meta.env.VITE_API_URL}/Api/Listing-uploads/upload/${
            params.id
          }`,
          {
            method: "POST",
